...
public class TestRobot extends AdvancedRobot {
	...
	public void run() {
		...
		// Loop forever
		for (;;) {
			// System.out.println(Math.toDegrees(getToCenterAngle()));
			// System.out.println(isAboutToHitWall());
			// DEBUG

			System.out.println(Math.toDegrees(absoluteBearing(new Point2D.Double(400, 300), new Point2D.Double(getX(), getY()))));
			;
